...
public interface GuitarOrderDao {
  ...
  Order saveOrder(String orderId, Customer customer, Guitar guitar, Strap strap, Capo capo,
      Stand stand, Pick pick, BigDecimal price);

  Order updateOrder(Order order, Customer customer, Guitar guitar, Strap strap, Capo capo,
      Stand stand, Pick pick, BigDecimal price);
